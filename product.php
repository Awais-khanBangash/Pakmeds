                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <ul  class="pro__prize">
                                    <li class="old__prize"><del>MRP<?php echo $get_product['0']['mrp']?></del></li>
                                    <li><strong>Price <?php echo $get_product['0']['price']?></strong></li>
                                </ul>
                                <p class="pro__info"><?php echo $get_product['0']['short_desc']?></p>
								<div class="sin__desc align--left">
                                        <p><span>Formula:</span></p>
                                        <ul class="pro__cat__list">
                                            <li><a href="#"><?php echo $get_product['0']['formula']?></a></li>
                                        </ul>
                                    </div>
								...
								<div id="social_share_box">
									...
									<a target="_blank" href="https://facebook.com/share.php?u=<?php echo $meta_url?>"><img src='images/social-icon/facebook.png'/></a>
									
									<a target="_blank" href="https://twitter.com/share?text=<?php echo $get_product['0']['name']?>&url=<?php echo $meta_url?>"><img src='images/social-icon/twitter.png'/></a>
									
									<a target="_blank" href="https://api.whatsapp.com/send?text=<?php echo urlencode($get_product['0']['name'])?> <?php echo $meta_url?>"> <img src='images/social-icon/whatsapp.png'/></a>
								</div>
										  ...
										  <div class="panel panel-default arrow left">
											<div class="panel-body">
											  <header class="text-left">
												<div class="rating_style"><span class="comment-rating"> <?php echo $product_review_row['rating']?></span > <span class="rating_name">(<?php echo $product_review_row['name']?>)</span></div>
									...
									<div class="category">
												...
												<div class="fr__product__inner">
													...
													<ul class="fr__pro__prize">
														<li class="old__prize"><del>MRP<?php echo $list['mrp']?></del></li>
														<li><strong>Price<?php echo $list['price']?></strong></li>
													</ul>
												</div>
											</div>
