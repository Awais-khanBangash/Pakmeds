						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="register-form" method="post">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="cnic" id="cnic"  minlength="13" placeholder="Your CNIC Number*" style="width:100%">
										</div>
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											...
											<input class="email_verify_otp" type="text" id="email_otp" placeholder="OTP*" style="width:45%">
									...
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="mobile" id="mobile"  minlength="11" placeholder="Your Mobile*" style="width:100%">
										</div>
										<span class="field_error" id="mobile_error"></span>
									</div>
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="password" name="password"  minlength="8" id="password" placeholder="Your Password*" style="width:100%">
										</div>
