                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1 class="font-size:12px"><?php echo $rowBanner['heading2']?></h1>
            ...
            <div class="container">
                ...
                <div class="htc__product__container">
                    <div class="row">
						...
						<?php
						$get_product=get_product($con,15);
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $list['id']?>">
                                            <img height="200px" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product images">
                                        </a>
                                    </div>
