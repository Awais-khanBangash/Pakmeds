...
$meta_title="PakMeds";
$meta_desc="Pakmeds.com: Pakistan Online Pharmacy | Buy Medicines Online, Fast Delivery";
$meta_keyword="Online Pharmacy Pakistan, Medicine Online, Medicine Store, Online Medical Store, Purchase Medicine Online";
...
<head>
	...
	<!--Product Share Tags -->
	<meta property="og:title" contant="<?php echo $meta_title?>"/>
	<meta property="og:image" contant="<?php echo $meta_image?>"/>
	<meta property="og:url" contant="<?php echo $meta_url?>"/>
	<meta property="og:site_name" contant="<?php echo SITE_PATH?>"/>
	<!--End Product Share Tags -->
...
<body>
	...
	<div class="whatsapp_float">
		<a href="https://wa.me/923029751915" target="_blank"><img src="images/whatsapp.png" class="whatsapp_float_btn" width="50px"/></a>
	</div>
    <!--[if lt IE 8]>
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/pakmedslogo.png" alt="logo images"></a>
                                </div>
                            </div>
